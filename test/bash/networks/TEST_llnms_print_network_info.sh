...
TEST_llnms_print_network_info_01(){
    ...
    $LLNMS_HOME/bin/llnms-create-network -n "Google DNS"  -as '8.8.8.8'  -ae '8.8.8.8' -o "$LLNMS_HOME/networks/google_dns.llnms-network.xml" >> $LLNMS_UNIT_TEST_LOG
    
    #   Check the name
    echo '  -> Testing the network name' >> $LLNMS_UNIT_TEST_LOG
    NETWORK_NAME="`$LLNMS_HOME/bin/llnms-print-network-info -n -o $LLNMS_HOME/networks/google_dns.llnms-network.xml`"
    ...
    NETWORK_START="`$LLNMS_HOME/bin/llnms-print-network-info -s -o $LLNMS_HOME/networks/google_dns.llnms-network.xml`"
    ...
    NETWORK_END="`$LLNMS_HOME/bin/llnms-print-network-info -e -o $LLNMS_HOME/networks/google_dns.llnms-network.xml`"
    ...
    $LLNMS_HOME/bin/llnms-create-network -n 'Home Network' -as '192.168.0.1'  -ae '192.168.0.254' -o "$LLNMS_HOME/networks/home_network.llnms-network.xml" >> $LLNMS_UNIT_TEST_LOG
    
    
    #   Check the name
    echo '  -> Testing the network name' >> $LLNMS_UNIT_TEST_LOG
    NETWORK_NAME="`$LLNMS_HOME/bin/llnms-print-network-info -n -o $LLNMS_HOME/networks/home_network.llnms-network.xml`"
    ...
    NETWORK_START="`$LLNMS_HOME/bin/llnms-print-network-info -s -o $LLNMS_HOME/networks/home_network.llnms-network.xml`"
