...
TEST_llnms_print_scanner_info_01(){
    ...
    OUT="`$LLNMS_HOME/bin/llnms-print-scanner-info -f $SCANFILE -i`"
    ...
    OUT="`$LLNMS_HOME/bin/llnms-print-scanner-info -f $SCANFILE -n`"
    ...
    OUT="`$LLNMS_HOME/bin/llnms-print-scanner-info -f $SCANFILE -c`"
